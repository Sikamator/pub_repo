            ...
            array(
                ...
                'items' => array(
                    ...
                    array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('city'),

                    ),

                    array(
                        'label' => 'Статус',
                        'url' => array('/admin/status'),
                    ...
                    array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('category'),
                    ...
                    array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('admin.statistics'),
                    ),
                    array(
                        'label' => 'Курьерка',
                        'url' => array('/courier/order'),
                        'visible' => Yii::app()->user->checkAccess('curier.order'),

                    ),
                    array(
                        'label' => 'Оператор',
                        'url' => array('/operator/order'),
                        'visible' => Yii::app()->user->checkAccess('operator.order'),
                    ),
                    array(
                        'label' => 'Города и пользователи',
                        'url' => array('/admin/cityuser'),
                        'visible' => Yii::app()->user->checkAccess('admin.cityuser'),
                    ),
